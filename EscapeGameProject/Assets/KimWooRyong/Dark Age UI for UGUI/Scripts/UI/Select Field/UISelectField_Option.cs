...
namespace DuloGames.UI
{
	public class UISelectField_Option : Toggle {
		...
		{
			if (this.selectField == null || this.animator == null || !this.animator.enabled || !this.animator.isActiveAndEnabled || !this.animator.hasBoundPlayables || this.animator.runtimeAnimatorController == null || string.IsNullOrEmpty(trigger))
				return;
