DarkAge Mobile UI for UGUI (v1.9)
April 18, 2015
...
PS: To use the joystick script you must import the unity cross-platform input package and then import the joystick script.