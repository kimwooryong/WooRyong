...
public class PlayerCotroller : MonoBehaviour
{
    ...
    public void playerHasWeaponItem()
    {
        ...
        {
            Debug.Log("칼이 활성화인 상태");
            isKnife = true;
            m_Animator.SetBool("isKnife", true);
        }
        else
        {
            Debug.Log("칼이 비활성화인 상태");
            isKnife = false;
    ...
    */
    ...
    public void ActiveWeapon()
    {
        ...
        if (!isEquipped)
        {
            ...
            if (isKnife == true && changeKnife == true)         // 칼
            {
            ...
            if (isHammer == true && changeHammer == true)       // 망치
            {
            ...
            if (isPickaxe == true && changePickaxe == true)     // 곡괭이
            {
